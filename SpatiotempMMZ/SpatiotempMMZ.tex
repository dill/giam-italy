...
Increased political interest ({\bf source?}), as well as academic interest has lead to a large amount of research into international migration, both theoretical and empirical, exploring its causes and consequences. Here our emphasis is to provide a tool for practitioners to provide spatial information for policy formulation. We first provide a review of previous work on the topic, before moving into the details of our proposal.
...
In the special issue of \textit{The Economic Journal} dedicated to ``the integration of immigrants and its consequences'', Manning (2010) observes that many European countries are currently experiencing a significant ({\bf cite!})
