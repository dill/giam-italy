...
\title{Modeling the Spatiotemporal Distribution of the Resident Foreign Population in Italy}
...
Manning (2010) has pointed that many European countries have recently experienced a substantial increase in the proportion of immigrants in the population. Given a specific area such municipality, province, region, or nation, a measure of density of foreign population is the percentage incidence of resident foreigners, given as the ratio of the number of resident foreigners to the total resident population multiplied by 100 (e.g., De Bartolo 2007; Lowell 2007; Coleman 2008; Miguet 2008). This gives a simple, well-known, demographic indicator for comparing different regions of a country in terms of number of foreigners per 100 resident inhabitants. It can be thought of as indicative of the spatial distribution of foreigners and thus identify areas of the country with a greater or lesser presence of resident foreigners in the population (e.g., OECD 2004). 

Here we consider the Italian case. According to the Italian National Statistical Office (ISTAT), the incidence of resident foreigners has grown substantially, from 2.7\% in 2002 to 6.5\% in 2008. This phenomenon has had an impact on the population, especially from a socio-demographic point of view (see Section \ref{DEM} for details). The incidence of foreigners calculated on a national level does not tell us anything specific on the spatial distribution of the phenomenon. In order to study and formulate adequate policies supporting, e.g., the process of integration of resident foreigners in a host country, demographers, economists, sociologists, and policy makers should find information on how the distribution of foreigners changes over time and space useful.
...
We now present the results of running the models detailed above. We first look at the results of the model for the incidence of resident foreigners, then the model for the constructed composite indicator. Finally, we discuss the possible interconnection between these two sets of maps.

\subsection{Spatiotemporal trends \label{STT}}

As mentioned in the introductory section, the incidence of foreigners in Italy was 6.5\% in 2008. This number tells us nothing about areas with particularly high or low levels of resident foreigners. Clearly, as we move to smaller aggregations (e.g. regional or provincial level) the same argument holds: some information is lost. This kind of low resolution statistic can mask smaller-scale heterogeneity in the population. Our aim here is to capture exactly this spatial heterogeneity. Figure \ref{fig1} shows the spatiotemporal trend of the incidence of resident foreign population in Italy for the period $2003-2008$. Two features stand out: 1) the distribution of foreigners is not homogeneous over space and time, and 2) the striking difference in incidence between north and south. Clearly this inhomogeneous distribution is not captured in the above, national, statistic.
...
From Figure \ref{fig1}, we can see that in 2003 the Po Valley (see Figure \ref{fig2}) is the area with the highest incidence of foreigners in Italy. Over the subsequent years ($2004-2008$), the incidence spreads, forming three distinct areas where foreigners tend to live. Focusing on 2008, the most popular area is the Po Valley, containing the Emilia--Romagna, Friuli Venezia Giulia, Lombardy and Veneto regions. This area, although popular in 2003, appears to have greatly expanded. The second most attractive area is made up of the central Italian regions of Tuscany, Umbria, Marche and Lazio. The final area is composed of the Liguria and Piedmont regions, located in the northwest of the country. There is also growth in the incidence at the Swiss and Austrian borders (from about 1\% in 2003 to about $3-4\%$ in 2008). We believe this growth is of interest because the area is characterized by mountains with medium-high altitudes, where, for example, job opportunities and lifestyle are different as compared to those of low-altitude areas. \textbf{not sure about this} However, in order to explain the appeal of these areas to foreigners further research is needed. Foreigners seem less attracted by the regions and islands of southern Italy.

\begin{figure}[tbp]
	\centering
		\includegraphics[width=0.55\textwidth, angle=270]{trends.ps}
	\caption{Temporal trends in incidence over the study period for Italy (top left), followed by trend estimates for north, central and south and islands areas. North was defined as those points in the prediction grid above -20 km north, central as between -20 km and -300, south and islands and below that, including Sardinia and Sicily.}
	\label{trends}
\end{figure}
...
The spatiotemporal patterns shown in Figure \ref{fig1} could be useful for policy-makers to decide the allocation of resources at local level; supporting policies and services needed for the process of integration of foreigners. In this regard, we would expect an area with a high density of resident foreigners to require more economic resources than an area with a low density. Such policies relate to a number of services such as: admission to education, access to the public health service, professional training, services supporting the match of demand and supply of labor \textbf{(job centres?)} (Zincone 2006). For sociologists and demographers these maps may represent a new way to model the spatiotemporal demographic behavior of a population and display the results graphically.
